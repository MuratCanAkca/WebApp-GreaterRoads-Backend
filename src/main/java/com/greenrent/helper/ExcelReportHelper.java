...
public class ExcelReportHelper {
	...
	//burada metotlar olacak
	
	//user bilgisini excel yapısına donusturucek
	...
	static String[] CAR_HEADERS= {"id","Model","Doors","Seats","Luggage","Transmission","AirConditinioning","Age" , "PricePerHour","FuelType"};
	
	static String SHEET_RESERVATION="Reservations";
	static String [] RESERVATION_HEADERS= {"Id","CarId","Car Model","CustomerId",
			"CustomerFullName","CustomerPhoneNumber", "PickUpTİme" , "DropOffTıme",
